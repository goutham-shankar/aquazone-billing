...
const METHOD_COLORS = {
  cash: "bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-300",
  card: "bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300",
  upi: "bg-purple-100 dark:bg-purple-900/20 text-purple-800 dark:text-purple-300",
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold text-white dark:text-gray-600">Transactions</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          <div className="text-center py-8 text-slate-500 dark:text-gray-400">Loading transactions...</div>
          ...
          <div className="divide-y divide-slate-200">
            {filteredTransactions.map((transaction) => {
              ...
              return (
                <div
                  key={transaction._id}
                  className="p-6 hover:bg-slate-50 dark:hover:bg-gray-800/50 transition-colors border-b border-gray-200 dark:border-gray-700 last:border-b-0"
                >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-3">
                          <h3 className="font-semibold text-white dark:text-gray-600">
          ...
          <div className="text-center py-8 text-slate-500 dark:text-gray-400">No transactions found</div>
        )}
      </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-600">
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Transaction ID</label>
                  <div className="text-slate-900 dark:text-gray-600 font-mono">{selectedTransaction.transactionId}</div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Invoice ID</label>
                  <div className="text-slate-900 dark:text-gray-600 font-mono">{selectedTransaction.invoiceId.invoiceId}</div>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Amount</label>
                  <div className={`text-slate-900 dark:text-gray-600 font-semibold text-lg ${
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Method</label>
                  <div className="text-slate-900 dark:text-gray-600">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-900 dark:text-gray-600 capitalize">{selectedTransaction.type}</div>
                </div>
              </div>

              {selectedTransaction.reference && (
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Reference</label>
                  <div className="text-slate-900 dark:text-gray-600 font-mono">{selectedTransaction.reference}</div>
                </div>
              )}

              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">Date & Time</label>
                <div className="text-slate-900 dark:text-gray-600">
            ...
            <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-750 flex justify-end">
              <button
                onClick={() => setShowDetails(false)}
