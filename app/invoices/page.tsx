                  ...
                  <table className="w-full">
                    <thead className="bg-slate-50">
                      <tr>
                        ...
                        <th className="text-right p-3 text-sm font-medium text-slate-700">Price</th>
                        <th className="text-right p-3 text-sm font-medium text-slate-700">Qty</th>
                    ...
                    <tbody className="divide-y divide-slate-200">
                      {selectedInvoice.items.map((item, index) => (
                        <tr key={index}>
                          ...
                          <td className="p-3 text-sm text-right">₹{(item.price * item.quantity).toFixed(2)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
